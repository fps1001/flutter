...
\newcommand{\nombre}{Fernando Pisot Serrano} %%% cambio de comando

% Datos de portada
\title{Desarrollo de una Aplicación Móvil para la Generación de Rutas Sostenibles utilizando un Framework de Datos Abiertos GIS en el Contexto de promoción de la Smartcity y los ODS}
\author{\nombre}
